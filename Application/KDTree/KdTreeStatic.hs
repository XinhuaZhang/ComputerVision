...
module Application.KDTree.KdTreeStatic
       ( -- * Introduction
...
inRadiusCount :: Real a => KdTree a p
                        -> a -- ^ radius
                        -> p -- ^ query point
                        -> Int -- ^ list of points in tree with given
                                  -- radius of query point
inRadiusCount (KdTree t) radius query = KDM.inRadiusCount t radius query
